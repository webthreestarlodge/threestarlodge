...
export default async function IslandEssentials() {
  ...
  return (
    <div className='w-full mx-auto'>
      <h3 className='text-[#897172] dark:text-gray-300 text-3xl md:text-7xl pb-6 md:pb-12 text-center font-extrabold'>
        Island Essentials
      </h3>
        ...
        {data &&
          data.map((item: any, index: number) => (
            <div
              ...
              {item.title && (
                <h6 className='text-[#897172] dark:text-gray-300 text-sm md:text-xl lg:text-2xl mt-6 pb-6 md:pb-12 text-center font-bold'>
                  {item.title}
                </h6>
              )}
            </div>
